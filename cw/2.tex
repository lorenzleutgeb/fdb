...
It remains to show that $\phi$ and $E_\phi$ are equivalent to complete this sketch. This proves domain independence since all relational algebra queries are domain independent.
\end{proof}
